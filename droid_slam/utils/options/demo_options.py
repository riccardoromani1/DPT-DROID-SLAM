...
class DemoOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument("--inference_mode", type=str, default="plot")
        ...
        parser.set_defaults(data_root="datasets/demo", name="demo", batch_size=1, height=40, width=60, num_tracks=60)
        return parser